      ...
      <div className="suggested-video">
        ...
        <div className="suggestion-content">
          <div class="video-info">
            <p class="track-title margin-0 video-info-title">{video.title}</p>
            <p class="margin-0 smaller-fontsize">{video.uploader}</p>
            <p class="margin-0 smaller-fontsize">{video.views} views</p>
            <p class="margin-0 smaller-fontsize">4 years ago</p>
          </div>
        </div>
      </div>
    </>
...
function VideoInfo(props) {
  ...
  const handleLikes = () => {
    let newLikes = JSON.parse(localStorage.getItem(`like_${video.id}`))
      ...
      : [];
    if (newLikes.includes(localStorage.getItem("userName"))) {
      newLikes.pop(localStorage.getItem("userName"));
    } else {
    ...
    const requesturl = `http://localhost:3000/video/${video._id}/like`;
      ...
      <div className="video-details">
        <div className="channel-info">
          ...
          <div className="channel-name">
            <h6 className="margin-0">{video.uploader}</h6>
        ...
        <div className="video-action-buttons">
          ...
          >
            ...
            {/* <LiaThumbsUp size={'1.4rem'} /> */}
            {likes} | <LiaThumbsDown size={"1.4rem"} />
          </button>
      ...
      <div className="video-main-page">
        <div className="video-frame">
          <iframe
            ...
            src={`https://www.youtube.com/embed/${currVideoId}?si=8TyAKqTfvtCYcIdO?rel=0&mute=1&autoplay=1`}
